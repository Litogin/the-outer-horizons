...
Репозиторий русскоязычного билда по SS14, за базе официального репозитория [space-wizards]().
...
Имейте в виду, что при контрибьюции вы автоматически соглашаетесь с условиями ICLA, [указанными в следующем файле](). Ознакомтесь с условиями, чтобы избежать недопонимания при дальнейшем контрибьюте.
...
- Если не указано иное, весь исходный код и ассеты, находящиеся в папках _OuterHorizons, подпадают под условия, указанные в файле [LICENSE_OH14.TXT]() (All rights reserved). Все ресурсы/контент в этих папках подпадают под CC-BY-SA 4.0, если не указано иное.

- Любой контент из SpaceWizards/SpaceStation14 без указанной лицензии на любой код лицензируется в соответствии с MIT ([LICENSE.txt]()). Любой контент Space Wizards лицензируется в соответствии с CC-BY-SA 3.0 для Space Wizards Federation & Contributors.
