...
public sealed partial class BlobSmoothFloorPlanBuilderComponent : Component
{
    /// <summary>
    ...
    [DataField(required: true)]
    public List<ProtoId<ContentTileDefinition>> CrustTileset { get; private set;  } = default!;

    [DataField("crustLayers")]
    public int CrustLayers = 1;
